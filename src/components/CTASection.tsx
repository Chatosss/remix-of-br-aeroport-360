  ...
  return (
    <section className="py-24 px-6">
      <div className="max-w-4xl mx-auto text-center">
        <motion.div
          className="glass-card rounded-3xl p-12 md:p-16 border-primary/20 relative overflow-hidden"
        ...
        >
          ...
          <div className="relative z-10">
            ...
            >
              <Button
                size="lg"
                className="h-14 px-12 text-base font-bold rounded-xl bg-primary hover:bg-primary/90 text-primary-foreground shadow-[0_0_30px_hsl(210,100%,56%,0.3)] hover:shadow-[0_0_40px_hsl(210,100%,56%,0.5)] hover:scale-105 transition-all duration-300"
              >
                [ Começar Agora ]
              </Button>
            </motion.div>
